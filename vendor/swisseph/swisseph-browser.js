...
// ../../node_modules/.pnpm/@swisseph+core@1.0.1/node_modules/@swisseph/core/dist/enums.js
var CalendarType;
...
// ../../node_modules/.pnpm/@swisseph+core@1.0.1/node_modules/@swisseph/core/dist/implementations.js
var _LunarEclipseImpl = class _LunarEclipseImpl {
  ...
  isPenumbralOnly() {
    return (this.type & EclipseType.Penumbral) !== 0 && (this.type & (EclipseType.Total | EclipseType.Partial)) === 0;
  }
  getTotalityDuration() {
...
var LunarEclipseImpl = _LunarEclipseImpl;
var _SolarEclipseImpl = class _SolarEclipseImpl {
...
var SolarEclipseImpl = _SolarEclipseImpl;
var _DateTimeImpl = class _DateTimeImpl {
  constructor(year, month, day, hour, calendarType = CalendarType.Gregorian) {
    this.year = year;
    this.month = month;
    this.day = day;
    this.hour = hour;
...
var DateTimeImpl = _DateTimeImpl;

// ../../node_modules/.pnpm/@swisseph+core@1.0.1/node_modules/@swisseph/core/dist/flags.js
var _CalculationFlags = class _CalculationFlags {
  ...
  static get swissEphemerisWithSpeed() {
    return _CalculationFlags.from(CalculationFlag.SwissEphemeris, CalculationFlag.Speed);
  }
  /**
   * Common preset: Moshier ephemeris with speed calculation
   */
  static get moshierWithSpeed() {
    return _CalculationFlags.from(CalculationFlag.MoshierEphemeris, CalculationFlag.Speed);
  }
  /**
   * Common preset: Astrometric positions (no aberration or light deflection)
   */
  static get astrometric() {
    return _CalculationFlags.from(CalculationFlag.SwissEphemeris, CalculationFlag.NoAberration, CalculationFlag.NoGravitationalDeflection);
  }
  /**
   * Common preset: Heliocentric positions
   */
  static get heliocentric() {
    return _CalculationFlags.from(CalculationFlag.SwissEphemeris, CalculationFlag.Heliocentric);
  }
  /**
   * Common preset: Topocentric positions
   */
  static get topocentric() {
    return _CalculationFlags.from(CalculationFlag.SwissEphemeris, CalculationFlag.Topocentric);
  }
  /**
   * Common preset: Equatorial coordinates (RA/Dec)
   */
  static get equatorial() {
    return _CalculationFlags.from(CalculationFlag.SwissEphemeris, CalculationFlag.Equatorial, CalculationFlag.Speed);
  }
};
__name(_CalculationFlags, "CalculationFlags");
var CalculationFlags = _CalculationFlags;
var _EclipseTypeFlags = class _EclipseTypeFlags {
  constructor(initialFlags) {
    this.flags = 0;
    if (initialFlags !== void 0) {
      this.add(initialFlags);
  ...
  static get totalOnly() {
    return _EclipseTypeFlags.from(EclipseType.Total);
  }
  /**
   * Preset: Total and partial eclipses (no penumbral)
   */
  static get totalAndPartial() {
    return _EclipseTypeFlags.from(EclipseType.Total, EclipseType.Partial);
  }
};
__name(_EclipseTypeFlags, "EclipseTypeFlags");
var EclipseTypeFlags = _EclipseTypeFlags;
